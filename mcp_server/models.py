...
class CertificateParameters(BaseModel):
    APPNO: str = Field(..., description='Application No', examples=['MMIG1907220002'])
    Date_Of_Birth: str = Field(
        ..., description='Date Of Birth', examples=['11-11-1990']
    )
    ENROLNO: str = Field(..., description='Enrollment No', examples=['MG005M010916003'])
    ROLLNO: str = Field(..., description='Roll No', examples=['1938805'])
...
class MicerCertificatePostRequest(BaseModel):
...
class MicerCertificatePostResponse(BaseModel):
...
class MicerCertificatePostResponse1(BaseModel):
...
class MicerCertificatePostResponse2(BaseModel):
...
class MicerCertificatePostResponse3(BaseModel):
...
class MicerCertificatePostResponse4(BaseModel):
...
class MicerCertificatePostResponse5(BaseModel):
...
class MicerCertificatePostResponse6(BaseModel):
    error: Optional[Error6] = None
    errorDescription: Optional[ErrorDescription6] = None


class PvcerCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class PvcerCertificatePostResponse(BaseModel):
...
class PvcerCertificatePostResponse1(BaseModel):
...
class PvcerCertificatePostResponse2(BaseModel):
...
class PvcerCertificatePostResponse3(BaseModel):
...
class PvcerCertificatePostResponse4(BaseModel):
...
class PvcerCertificatePostResponse5(BaseModel):
...
class PvcerCertificatePostResponse6(BaseModel):
